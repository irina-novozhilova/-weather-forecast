...
/* unused harmony export storageManager */
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          drawList = function _drawList(el, items) {
            var curEl = el;
            curEl.innerHTML = "<ol>".concat(items.map(function (cur) {
              return "<li><a href=\"#\">".concat(cur, "</a></li>");
            }).join(""), "</ol>");
            var citiesLinks = rootElement.querySelectorAll("a");
            citiesLinks.forEach(function (curCity) {
              curCity.addEventListener("click", function (ev) {
                ev.preventDefault();
                var city = curCity.innerHTML;
